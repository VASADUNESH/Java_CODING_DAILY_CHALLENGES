...
public class p1 {
	...
	public static void Status(double remainingAmount) {
		if (remainingAmount >= 0) {
	         System.out.println("Extra amount paid: "+Math.abs(remainingAmount));
	     }
	...
	public static void main(String[] args) {
		...
		Student student = new Student(1, "John Smith", 25000.0);
	     DayScholar dayScholar = new DayScholar(2, "Brian Lara", 35000.0, 5000.0);
	     ...
	     Status(dayScholar.payFee(37000.0));
	     Status(hosteller.payFee(24000.0));
