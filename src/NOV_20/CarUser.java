...
class CarStopppedException extends Exception{
	public CarStopppedException(String message) {
		super(message);
	}
}
...
class CarTest{
	public static void Stop(String message)  throws CarStopppedException{
		if (message.equals("stops")) {
			throw new CarStopppedException("Car stopped");
		}
		else {
			System.out.println("Car not stoppped");
		}
	}
	public static void puncture(String message) throws CarPunctureException{
		if (message.equals("puncture")) {
			throw new CarPunctureException("Car Puncture");		}
		else {
	...
	public static void carHeat(int temp) throws CarHeatException{
		if (temp>50) {
			throw new CarHeatException("Car Over Heated more than 50 c");
		}
		else {
			System.out.println("Car tempeture normal");
		}
	}
}
...
Batc ... .txt
Displaying Batch_37_Assignment.txt.
*/